//
//  PEPSessionConcurrentProtocol.h
...
///
/// @Note The return value is only nullable to indicate error.
...
- (NSNumber * _Nullable)queryKeySyncEnabledForIdentity:(PEPIdentity *)identity
                                                 error:(NSError * _Nullable * _Nullable)error;
